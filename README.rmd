...
You might want to plot the tree.
...
These two figures indicate that the best index is not __I__. As it is also important to estimate the error, you can use the following code to compute it.
...
In case you want to know the index that explains the most, use this code:
...
You can get the ranking in the first run. It is only necessary to run this line:
...
And with this instruction you can identify the type of error.
